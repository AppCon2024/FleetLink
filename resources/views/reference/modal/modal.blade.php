...
<x-modal1 name="delete" title="Modal 1">
    <x-slot:body>
...
<div
    x-show = "add"
    x-on:close-modal.window ="add = false"
    style="display:none;"
    class="fixed z-50 inset-0">
    <!--Gray Background-->
    <div x-on:click="add = false" class="fixed inset-0 bg-gray-800 opacity-40"></div>
    <!--Modal Body-->
...
<div
    x-show = "delete"
    x-on:close-modal.window ="delete = false"
    style="display:none;"
    class="fixed z-50 inset-0">
    <!--Gray Background-->
    <div x-on:click="delete = false" class="fixed inset-0 bg-gray-800 opacity-40"></div>
    <!--Modal Body-->
    <div class="fixed inset-0 overflow-y-auto flex items-center justify-center">
        <div>
            <h3>try</h3>

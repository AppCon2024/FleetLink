                        ...
                        <tbody>
                            @foreach ($accounts as $account)
                                <tr x-on:click="itemToEdit = {{ $account->id }};">
                                    ...
                                    <td class="text-center">{{ $account->position }}</td>
                                            ...
                                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    <select name="department"
                                                        ...
                                                        <option value=""
                                                            {{ $account->department == '' ? 'selected' : '' }}>
                                                        </option>
                                                        <option value="Admin PNCO"
                                                            {{ $account->department == 'Admin PNCO' ? 'selected' : '' }}>
                                                            Admin PNCO</option>
                                                        <option value="Operation PNCO"
                                                            {{ $account->department == 'Operation PNCO' ? 'selected' : '' }}>
                                                            Operation PNCO</option>
                                                        <option value="Investigation PNCO"
                                                            {{ $account->department == 'Investigation PNCO' ? 'selected' : '' }}>
                                                            Investigation PNCO</option>
                                                        <option value="Finance PNCO"
                                                            {{ $account->department == 'Finance PNCO' ? 'selected' : '' }}>
                                                            Finance PNCO</option>
                                                        <option value="Logistics PNCO"
                                                            {{ $account->department == 'Logistics PNCO' ? 'selected' : '' }}>
                                                            Logistics PNCO</option>
                                                        <option value="Police Clearance PNCO"
                                                            {{ $account->department == 'Police Clearance PNCO' ? 'selected' : '' }}>
                                                            Police Clearance PNCO</option>
                                                        <option value="Intel PNCO"
                                                            {{ $account->department == 'Intel PNCO' ? 'selected' : '' }}>
                                                            Intel PNCO</option>
                                                    </select>
                                                    @error('department')
                                                ...
                                                <div>
                                                    ...
                                                    <select name="position"
                                                        class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white  mb-2">
                                                        <option value=""
                                                            {{ $account->position == '' ? 'selected' : '' }}></option>
                                                        <option value="Police Captain Deputy"
                                                            {{ $account->position == 'Police Captain Deputy' ? 'selected' : '' }}>
                                                            Police Captain Deputy</option>
                                                        <option value="Police Executive Master Sergeant"
                                                            {{ $account->position == 'Police Executive Master Sergeant' ? 'selected' : '' }}>
                                                            Police Executive Master Sergeant</option>
                                                        <option value="Station's Support and Services Officer"
                                                            {{ $account->position == "Station's Support and Services Officer" ? 'selected' : '' }}>
                                                            Station's Support and Services Officer</option>
                                                        <option value="Police Lieutenant"
                                                            {{ $account->position == 'Police Lieutenant' ? 'selected' : '' }}>
                                                            Police Lieutenant</option>
                                                        <option value="Police Chief Master Sergeant"
                                                            {{ $account->position == 'Police Chief Master Sergeant' ? 'selected' : '' }}>
                                                            Police Chief Master Sergeant</option>
                                                        <option value="Police Master Sergeant"
                                                            {{ $account->position == 'Police Master Sergeant' ? 'selected' : '' }}>
                                                            Police Master Sergeant</option>
                                                        <option value="Police Staff Sergeant"
                                                            {{ $account->position == 'Police Staff Sergeant' ? 'selected' : '' }}>
                                                            Police Staff Sergeant</option>
                                                        <option value="Police Corporal"
                                                            {{ $account->position == 'Police Corporal' ? 'selected' : '' }}>
                                                            Police Corporal</option>
                                                        <option value="Police Major"
                                                            {{ $account->position == 'Police Major' ? 'selected' : '' }}>
                                                            Police Major</option>
                                                        <option value="Patrolman"
                                                            {{ $account->position == 'Patrolman' ? 'selected' : '' }}>
                                                            Patrolman</option>
                                                        <option value="Patrolwoman"
                                                            {{ $account->position == 'Patrolwoman' ? 'selected' : '' }}>
                                                            Patrolwoman</option>
                                                    </select>
                                                    @error('position')
                                                        <p class="text-red-500 text-xs p-1">
                                    ...
                                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                        <div>
                                            <label for="first_name"
                                                class="block mb-2 text-sm font-medium text-gray-900">Firstname
                                                :</label>
                                            <input type="text" name="first_name"
                                        ...
                                        <div>
                                            <label for="employee_id"
                                                class="block mb-2 text-sm font-medium text-gray-900">Employee ID
                                                :</label>
                                        ...
                                        <div>
                                            <label for="email"
                                                class="block mb-2 text-sm font-medium text-gray-900">Email Address
                                                :</label>
                                        ...
                                        <div>
                                            <label for="department"
                                                class="block mb-2 text-sm font-medium text-gray-900">Deparment
                                                :</label>
                                            <select name="department"
                                                class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mb-2">
                                                <option value=""
                                                    {{ old('department') == '' ? 'selected' : '' }}></option>
                                                <option value="Admin PNCO"
                                                    {{ old('department') == 'Admin PNCO' ? 'selected' : '' }}>Admin
                                                    PNCO</option>
                                                <option value="Operation PNCO"
                                                ...
                                                <option value="Investigation PNCO"
                                                    ...
                                                    Investigation PNCO</option>
                                                <option value="Finance PNCO"
                                                    {{ old('department') == 'Finance PNCO' ? 'selected' : '' }}>
                                                    Finance PNCO</option>
                                                <option value="Logistics PNCO"
                                                ...
                                                <option value="Police Clearance PNCO"
                                                    ...
                                                    Police Clearance PNCO</option>
                                                <option value="Intel PNCO"
                                                    {{ old('department') == 'Intel PNCO' ? 'selected' : '' }}>Intel
                                                    PNCO</option>
                                            </select>
                                            @error('department')
                                                <p class="text-red-500 text-xs p-1">
                                        ...
                                        <div>
                                            ...
                                            <select name="position"
                                                ...
                                                <option value="Police Major"
                                                    ...
                                                    Major</option>
                                                <option value="Patrolman"
                                                    {{ old('position') == 'Patrolman' ? 'selected' : '' }}>Patrolman
                                                </option>
                                                <option value="Patrolwoman"
                                                    {{ old('position') == 'Patrolwoman' ? 'selected' : '' }}>
                                                    Patrolwoman</option>
                                            </select>
                                            @error('position')
                                                <p class="text-red-500 text-xs p-1">
                    ...
                    <div x-show="accountDelete"
                        ...
                        <div x-show="accountDelete" @click.away="accountDelete = false"
                            ...
                            <div class="p-4 md:p-5 space-y-4">
                                ...
                                <div
                                    class="flex items-center justify-end p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                                    <form method="post" :action="`{{ route('sms.sms', '') }}/${itemToDelete}`">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button"
                                            class="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">

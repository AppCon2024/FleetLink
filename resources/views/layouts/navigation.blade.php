            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        ...
                        <a href="{{ route('dashboard') }}">
                            <h3 name="logo"
                                class="mt-2 ml-2 font-abnes font-bold sm:text-2xl text-sm text-blue-600 ">
                                FLEETLINK</h3>
                        </a>
                    </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent font-poppins leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150 capitalize">
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                @if (Auth::user()->role == 'admin')
                    ...
                    <x-responsive-nav-link :href="route('chatify')" wire:navigate :active="request()->routeIs('chatify')">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @if (Auth::user()->role == 'supervisor')
                    ...
                    <x-responsive-nav-link :href="route('tracking')" wire:navigate :active="request()->routeIs('tracking')">
                        <div class="flex items-center">
